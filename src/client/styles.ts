...
:host { all: initial; color-scheme: dark; --af-accent:#7c3aed; font:13px/1.4 Inter,ui-sans-serif,system-ui,sans-serif; pointer-events:none; }
*,*::before,*::after { box-sizing:border-box; }
button,textarea { font:inherit; }
.af-dock { position:fixed; left:calc(50vw - 210px); bottom:20px; z-index:2147483000; display:flex; align-items:center; gap:4px; padding:6px; color:#fafafa; background:#18181b; border:1px solid #3f3f46; border-radius:14px; box-shadow:0 10px 35px #0008; pointer-events:auto; }
...
.af-panel,.af-composer,.af-editor,.af-copy-fallback,.af-tooltip { position:fixed; z-index:2147483010; padding:12px; color:#fafafa; background:#18181b; border:1px solid #3f3f46; border-radius:12px; box-shadow:0 12px 36px #0009; pointer-events:auto; }
